...
/** Maps a human-readable product id to the app's subscription tier. */
export function tierForProduct(productId: string | null | undefined): "free" | "plus" | "pro" {
  if (productId === "pro_plan") return "pro";
  if (productId === "plus_plan") return "plus";
  return "free";
}
